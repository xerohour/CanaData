...
def test_process_menu_json_thread_safe_counts_and_collections():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=8) as executor:
        ...
        for future in concurrent.futures.as_completed(futures):
            ...
            # Since CanaData is now stateless at the process layer, manually aggregate it
            # like the Sequential/Concurrent runner would.
            listing_id = result['listing_id']
            cana.allMenuItems[listing_id] = result['local_menu_items']
