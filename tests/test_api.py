...
def test_extract_strains_from_menu(cana):
    ...
    # Assign the result back to the mock to pretend it passed through _getMenusSequential or _getMenusConcurrent
    cana.extractedStrains.update(result['local_extracted_strains'])
