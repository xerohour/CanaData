...
- Scaled benchmarks confirmed the overhead. Processing 500 items took ~0.1199 seconds with `OptimizedDataProcessor` versus ~0.0282 seconds with legacy flat iteration.
