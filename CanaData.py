...
class CanaData:
    ...
    def _getMenusConcurrent(self):
        ...
        results_map = processor.process_locations(self.locations, process_location_menu)

        # Sequentially merge mapped results
    ...
    def _fetch_and_process_menu(self, location: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """Fetch and process menu for a single location. Returns processed menu data mapping."""
        location_slug = location["slug"]
    ...
    def _merge_menu_result(self, result: Dict[str, Any]) -> None:
        """
        Merge a mapped menu result dictionary sequentially into the main state.
        """
        if not result:
            return
    ...
    def process_menu_json(self, menu_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'empty_menu_copy': listing_copy if is_empty_menu else None,
            'extracted_strains': local_extracted_strains,
            'menu_items_count': menu_items_count,
            'total_location_copy': listing_copy
        }
    ...
    def process_menu_items_json(self, menu_json: Dict[str, Any], location: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            'listing_id': listing_id,
            'local_menu_items': local_menu_items,
            'empty_menu_copy': listing_copy if menu_items_count == 0 else None,
            'extracted_strains': local_extracted_strains,
            'menu_items_count': menu_items_count,
            'total_location_copy': listing_copy
        }
