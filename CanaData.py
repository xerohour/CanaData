...
class CanaData:
    ...
    def flatten_dictionary(self, d: dict[str, Any]) -> dict[str, str]:
        ...
        # Local variable caching for performance in tight inner loops
