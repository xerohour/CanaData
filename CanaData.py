...
class CanaData:
    ...
    def _getMenusConcurrent(self):
        ...
        # Update instance variables with results sequentially to avoid lock contention
    ...
    def _fetch_and_process_menu(self, location: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        Returns the result dictionary to be merged, or None on failure.
        """
        location_slug = location["slug"]
    ...
    def process_menu_json(self, menu_json: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        Returns a dictionary containing the local state changes.
        """
    ...
    def _merge_menu_result(self, result: Optional[Dict[str, Any]]) -> None:
        """Merge a processed menu result dictionary into the main state."""
        if not result:
            return
