...
class CanaData:
    ...
    def _original_organize_into_clean_list(self):
        ...
        # Optimization: Pre-allocate a template dictionary instead of using dict comprehension
        # in the loop. 'item' values are already strings from flatten_dictionary.
