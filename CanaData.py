...
class CanaData:
    ...
    def _sanitize_filename(self, filename: str) -> str:
        ...
        Returns:
            str: A safe filename containing only alphanumeric characters, underscores, and hyphens.
        """
        # Remove directory components to prevent path traversal
        filename = os.path.basename(filename)
        # Replace characters that aren't alphanumeric, underscores, or hyphens with an underscore
