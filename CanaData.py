...
class CanaData:
    ...
    def _getMenusConcurrent(self):
        ...
        # Update instance variables with results by merging them sequentially
    ...
    def _merge_menu_result(self, result: Optional[Dict[str, Any]]) -> None:
        """Merge the isolated result dictionary from processing back into the main state."""
        if not result:
            return
        ...
        listing_slug = result['listing_slug']
