...
class CanaData:
    ...
    def _merge_menu_result(self, result: Dict[str, Any]) -> None:
        """Merge isolated map-reduce dictionary payload into instance state sequentially."""
        if not result:
            return
        ...
        local_extracted_strains = result.get('local_extracted_strains', {})
    ...
    def _getMenusConcurrent(self):
        ...
        # Merge map-reduce results sequentially on main thread
