...
class CanaData:
    ...
    def _original_organize_into_clean_list(self):
        ...
        # Optimize dictionary merging using Python 3.9+ union operator and list comprehension
        # This avoids iterative .copy() and .update() method calls for better performance
