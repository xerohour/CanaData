...
class CanaData:
    ...
    def _getMenusConcurrent(self):
        ...
        # Apply the sequential reduce step
    ...
    def _merge_menu_result(self, result: Dict[str, Any]) -> None:
        """
        Merge a processed menu result into the central class state.
        This represents the 'reduce' step in the map-reduce architecture.
        """
        if not result:
            return
