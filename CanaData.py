...
class CanaData:
    ...
    def _getMenusSequential(self):
        ...
        for i, location in enumerate(self.locations):
            ...
            for s_slug, strain in result['local_extracted_strains'].items():
                if s_slug not in self.extractedStrains:
                    self.extractedStrains[s_slug] = strain
    ...
    def _getMenusConcurrent(self):
        ...
        # Update instance variables sequentially based on concurrent results
