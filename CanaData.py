...
class CanaData:
    ...
    def _original_organize_into_clean_list(self):
        ...
        # Pre-create the base dictionary to avoid re-evaluating the comprehension on every iteration
        base_dict = {key: 'None' for key in all_keys}

        # Loop through the flatDictList to update any missing keys
        for item in flatDictList:
            # Create a dictionary with all keys initialized to 'None' by copying
