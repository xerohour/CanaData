...
class CanaData:
    ...
    def __init__(
        ...
        self.menu_update_queue = queue.Queue()
    ...
    def flush_queue(self) -> None:
        """Process all deferred menu updates from the internal queue."""
        while not self.menu_update_queue.empty():
            try:
                update = self.menu_update_queue.get_nowait()
                ...
                self.menu_update_queue.task_done()
            except queue.Empty:
                break
