...
## 2026-08-11 - Smooth Scrolling Accessibility
**Learning:** Smooth scrolling improves navigation for anchor links, but must respect users with vestibular disorders.
**Action:** Wrap scroll-behavior: smooth; in @media (prefers-reduced-motion: no-preference).
