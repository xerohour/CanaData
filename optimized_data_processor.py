...
class OptimizedDataProcessor:
    ...
    def process_menu_data(
            self, all_menu_items: Dict[str, List[Dict]]) -> List[Dict[str, Any]]:
        """
    ...
    def _flatten_all_items(self,
                           all_menu_items: Dict[str,
