...
class OptimizedDataProcessor:
    ...
    def _flatten_dictionary_custom(self, d: Dict) -> Dict:
        ...
        Uses a highly efficient stack of (dict, prefix) pairs to avoid `iter()` overhead.
        """
        # Pre-allocate result dict with estimated size
        result = {}

        # Use iterative approach with explicit stack of (dict, prefix) tuples
        stack = [(d, "")]
        ...
        while stack:
            ...
            for k, v in curr_dict.items():
                ...
                if isinstance(v, dict):
                    # Push nested dict to stack with its new prefix
                    stack.append((v, key))
