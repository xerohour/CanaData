...
class OptimizedDataProcessor:
    ...
    def _handle_remaining_nesting(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        for col in df.columns:
            ...
            # Optimization: Use first_valid_index to avoid O(N) memory overhead from dropna()
        ...
        for col in nested_columns:
            try:
                ...
                # Optimization: List comprehension is faster than .apply(lambda) on object columns
