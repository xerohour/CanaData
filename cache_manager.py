...
class CacheManager:
    ...
    def _get_from_disk(self, cache_key: str) -> Optional[Any]:
        ...
        try:
            ...
            logger.warning(f"Discarding unreadable/legacy cache file {cache_file}: {e}")
    ...
    def _set_to_disk(self, cache_key: str, data: Any) -> None:
        ...
        try:
            ...
            logger.warning(f"Failed to save cache file {cache_file}: Data is not JSON serializable - {e}")
