...
class CacheManager:
    ...
    def _get_from_disk(self, cache_key: str) -> Optional[Any]:
        ...
        if not cache_file.exists():
            # Check for legacy .cache files and remove them securely
        ...
        try:
            ...
            # Load cached data securely using json to prevent deserialization attacks
    ...
    def _set_to_disk(self, cache_key: str, data: Any) -> None:
        ...
        try:
            # Save data securely using json instead of pickle
