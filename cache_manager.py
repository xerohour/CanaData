...
class CacheManager:
    ...
    def _get_from_disk(self, cache_key: str) -> Optional[Any]:
        ...
        if legacy_cache_file.exists():
            # Safely unlink legacy pickle cache files without loading them to prevent RCE
            try:
        ...
        try:
            ...
            # Load cached data safely using json
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        disk_files = 0
        if self.enable_disk_cache:
            disk_files = len(list(self.cache_dir.glob("*.cache"))) + len(list(self.cache_dir.glob("*.json")))
