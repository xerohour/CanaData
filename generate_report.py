...
def sanitize_url(url: str) -> str:
    """Sanitize URLs to prevent javascript: URI execution."""
    url = str(url).strip()
        ...
        html_content += f"""
                <div class="card">
                    <div class="card-header">
                        <img src="{html.escape(sanitize_url(avatar))}" alt="{html.escape(str(item.get('name') or ''))}" class="avatar">
                    ...
                    <div class="footer-actions">
                        ...
                        <a href="{html.escape(sanitize_url(item.get('web_url') or '#'))}" target="_blank" rel="noopener noreferrer" aria-label="View {html.escape(str(item.get('name', '')))} on Weedmaps" class="btn btn-primary">View on Weedmaps</a>
                    </div>
                </div>
        """
