...
def generate_html_report(data, region_name="Colorado"):
    ...
    *:focus-visible {
    ...
    <head>
        ...
        <meta http-equiv="Content-Security-Policy" content="default-src 'self'; img-src * data:; style-src 'unsafe-inline' https://fonts.googleapis.com; font-src https://fonts.gstatic.com;">
    ...
    for item in listings:
        ...
        # Security: Validate avatar URL to prevent javascript: execution.
        safe_avatar = str(avatar) if str(avatar).startswith(('http://', 'https://')) else 'https://images.weedmaps.com/static/avatar/dispensary.png'

        html_content += f"""
                <div class="card">
                    <div class="card-header">
                        <img src="{html.escape(safe_avatar)}" alt="{html.escape(str(item.get('name') or ''))}" class="avatar">
                    ...
                    <div class="footer-actions">
                        ...
                        <a href="{html.escape(str(item.get('web_url')) if str(item.get('web_url')).startswith(('http://', 'https://', '#')) else '#')}" target="_blank" rel="noopener noreferrer" aria-label="View {html.escape(str(item.get('name', '')))} on Weedmaps" class="btn btn-primary">View on Weedmaps</a>
                    </div>
                </div>
        """
