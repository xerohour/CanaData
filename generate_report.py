    ...
    if not listings:
        html_content += """
                <div class="empty-state">
                    ...
                    <p>We couldn't find any dispensaries or delivery services matching your criteria in this region. Please try searching a different area or adjusting your filters.</p>
                </div>
        """
    else:
