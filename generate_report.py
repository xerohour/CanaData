...
def generate_html_report(data, region_name="Colorado"):
    ...
    *:focus-visible {
    ...
    if not listings:
        html_content += """
                <div class="card empty-state" style="grid-column: 1 / -1; text-align: center; padding: 4rem 2rem;">
                    <div class="card-body">
                        <h2>No listings found</h2>
                        <p class="meta-summary" style="margin-top: 1rem;">We couldn't find any listings matching your criteria in this region. Try adjusting your search.</p>
                    </div>
                </div>
        """
