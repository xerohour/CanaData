                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="listing-info">
                            ...
                            <span class="badge badge-rating" role="img" aria-label="Rating: {rating} stars based on {reviews} reviews">★ {rating} ({reviews})</span>
                    ...
                    <div class="footer-actions">
                        ...
                        <a href="{item.get('web_url')}" target="_blank" rel="noopener noreferrer" class="btn btn-primary" aria-label="View {item.get('name')} on Weedmaps (opens in a new tab)">View on Weedmaps</a>
                    </div>
                </div>
        """
