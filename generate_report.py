...
def generate_html_report(data, region_name="Colorado"):
    ...
    *:focus-visible {
    ...
    <head>
        ...
        <meta http-equiv="Content-Security-Policy" content="default-src 'self'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src https://fonts.gstatic.com; img-src 'self' https: data:;">
        ...
        html_content += f"""
                <div class="card">
                    <div class="card-header">
                        <img src="{sanitize_url(avatar)}" alt="{html.escape(str(item.get('name') or ''))}" class="avatar">
                    ...
                    <div class="footer-actions">
                        ...
                        <a href="{sanitize_url(item.get('web_url'))}" target="_blank" rel="noopener noreferrer" aria-label="View {html.escape(str(item.get('name', '')))} on Weedmaps" class="btn btn-primary">View on Weedmaps</a>
                    </div>
                </div>
        """
