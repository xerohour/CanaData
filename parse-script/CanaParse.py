...
class CanaParse:
    ...
    def apply_filters(self):
        ...
        # Pre-calculate string representations of all rows for faster word-based searching
        # across multiple filters. This drastically improves performance.
        ...
        for f in self.filters:
            ...
            # Apply filters
            filtered: List[Any] = [
                row[:] for row, row_str in zip(self.raw_data, row_strs) # copy row to avoid mutating raw_data
    ...
    def is_match(self, row, f, price_col, row_str):
        ...
        # 3. Join row for word-based searches (already provided via row_str)
        # 4. Brands
        if f.brands:
